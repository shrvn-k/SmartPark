...
def get_registered_vehicles():
    ...
    curr = conn.execute('select v.Lplate,o.Name,a.Username,r.Date from Owner o,Vehicle v,Admin a,Registry r,Ownership os where o.Oid = os.Oid and v.Vid = os.Vid and r.Aid = a.Aid and r.Vid = os.Vid')
